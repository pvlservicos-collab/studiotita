export const metadata = { title: "Estúdio Reels" };
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-500">
            As telas que entram nos vídeos do Augusto. Ao criar um roteiro com &quot;Gerar cenas&quot; ligado, o Gemini sugere as cenas
            usando o que este estúdio sabe fazer.
          </p>
        </div>
        <a
          href="/estudio-reels.html"
          target="_blank"
